...
const tracks = [
  ...
  {
    slug: 'associate-python-developer',
    name: 'Associate Python Developer',
    language: 'Python',
    color: '#38bdf8',
    description: 'Write clean, structured Python code and master developer tooling',
  },
]
...
const coursesByTrack = {
  'associate-data-scientist-python': [
    ...
    ['introduction-to-statistics-in-python', 'In Progress', 'Hard', 'Repeat In Progress', 'No'],
    ...
    ['introduction-to-functions-in-python', 'Completed', 'Easy', 'Completed', 'Yes'],
    ['python-toolbox', 'Completed', 'Medium', 'Repeat Completed', 'Yes'],
    ...
    ['introduction-to-importing-data-in-python', 'In Progress', 'Medium', '-', 'No'],
    ['cleaning-data-in-python', 'Not Started', 'Unknown', '-', 'No'],
    ['working-with-dates-and-times-in-python', 'Completed', 'Medium', 'Practice Code Completed', 'No'],
    ['writing-functions-in-python', 'Completed', 'Hard', 'Repeat Completed', 'No'],
    ...
    ['experimental-design-in-python', 'Not Started', 'Unknown', '-', 'No'],
    ['supervised-learning-with-scikit-learn', 'Not Started', 'Unknown', '-', 'No'],
    ['unsupervised-learning-in-python', 'Not Started', 'Unknown', '-', 'No'],
    ['machine-learning-with-tree-based-models-in-python', 'Not Started', 'Unknown', '-', 'No'],
  ],
  ...
  'associate-python-developer': [
    ['introduction-to-python-for-developers', 'Completed', 'Easy', 'Completed', 'Yes'],
    ['intermediate-python-for-developers', 'Completed', 'Easy', 'Completed', 'Yes'],
    ['python-toolbox', 'Completed', 'Hard', 'Repeat Completed', 'Yes'],
    ['data-types-in-python', 'Completed', 'Medium', 'Completed', 'No'],
    ['working-with-dates-and-times-in-python', 'Completed', 'Medium', 'Completed', 'No'],
    ['writing-functions-in-python', 'Completed', 'Medium', 'Completed', 'No'],
    ['regular-expressions-in-python', 'Completed', 'Hard', 'Repeat Completed', 'No'],
    ['introduction-to-object-oriented-programming-in-python', 'Completed', 'Easy', 'Completed', 'No'],
    ['introduction-to-shell', 'Completed', 'Easy', 'Completed', 'No'],
  ],
}
